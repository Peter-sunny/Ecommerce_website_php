...
if (isset($_POST['name'], $_POST['date'], $_POST['snote'],$_POST['lnote'])) {
    ...
    if ($date !='') {
              ...
              $insert_stmt = $mysqli->prepare("INSERT INTO newsmaker (title, date , pic , snote ,lnote) VALUES (?, ?, ?,?,?)"); 
              $i = serialize($images_arr);
            $insert_stmt->bind_param('sssss', $name, $date, $i, $snote,$lnote);
