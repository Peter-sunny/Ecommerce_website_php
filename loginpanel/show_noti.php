      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <ul class="list-group">
                <?php
                if($stmt = $mysqli->prepare("SELECT id,title , date, snote,lnote,pic  FROM newsmaker WHERE id = ?")) {
                    ...
                    while ($stmt->fetch()) {
                       ...
                       if(!empty($images)){
                        foreach($images as $image_src){ ?>
                            ...
                            echo  '<a class="btn btn-success" href="delete_n.php?id='.$id.'" style="margin:10px;">Delete</a>';
                            ...
                            <form method="post" name="multiple_upload_form" id="multiple_upload_form" enctype="multipart/form-data" action="edit_n.php">
