...
<html lang="en">
  <head>
    ...
    <title>ALCHEMI Admin Page</title>
...
<script>
    ...
    $("#images").change(function () {
        var fileExtension = ['jpeg', 'jpg', 'png', 'gif', 'bmp','txt', 'pdf', 'doc', 'xml','xlsx','docx'];
...
<li class="">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-table"></i>Download CMS</h3>
          
        </div>
      </div>                <?php 
                if($_SESSION['user_type']=='admin'){
                    echo '<a class="btn btn-success" data-toggle="modal" href="#myModal" style="margin:15px;">Add Downloads</a>
                                                                                                ...
                                                                                                <div class="modal-dialog">
                                                                                                    <div class="modal-content">
                                                                                                        ...
                                                                                                        <div class="modal-body">
                                                                                                            <form method="post" name="multiple_upload_form" id="multiple_upload_form" enctype="multipart/form-data" action="upload_dlink.php">
                    <div class="col-sm-12"> 
                                    <br>
        ...
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
          ...
          <div class="container">
              ...
              <?php
                                    $stmt2 = $mysqli->prepare ("SELECT id,title , date, snote,dlink  FROM downloads order by id asc");
                                      if($stmt2->execute()) {
                                         $stmt2->bind_result($id,$title, $date, $snote,$pic);
                     ...
                     while ($stmt2->fetch()) {
                        ...
                        echo '<tr>
                                                                         ...
                                                                         <td>'.$date.'</td>
                                                                         <td>'.$snote.'</td>
                                                                         <td><a href="show_dnoti.php?id='.$id.'">View/Edit</a></td></tr>';
