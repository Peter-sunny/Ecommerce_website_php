          ...
          <div class="row">
              ...
              <div class="row">
                  <div class="col-lg-12">
                    <ul class="list-group">
                    <?php
                                if($stmt = $mysqli->prepare("SELECT id,title , date, snote,dlink  FROM downloads WHERE id = ?")) {
                                    $stmt->bind_param('i',$_GET['id']);
                                    $stmt->execute();
                                    $stmt->bind_result($id,$title,$date,$snote,$pic);
                ...
                <?php
                  ...
                  echo  '<a class="btn btn-success" href="delete_d.php?id='.$id.'" style="margin:10px;">Delete</a>';
                   ...
                   <form method="post" name="multiple_upload_form" id="multiple_upload_form" enctype="multipart/form-data" action="edit_d.php">
