...
alert("Cleared Everything !!");                   }
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          ...
          <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-table"></i>View Testimonial</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="testimonials.php">Back To Testimonials List</a></li>
                    </ol>
                </div>
            </div>
              <div class="row">
                  <div class="col-lg-12">
                    <ul class="list-group">
                    <?php
                                if($stmt = $mysqli->prepare("SELECT id,customer,testimonial FROM testimonials WHERE id = ?")) {
                                    ...
                                    $stmt->bind_result($id,$customer,$testimonial);
                                           ...
                                           while ($stmt->fetch()) {
                                             ...
                                             echo '<li class="list-group-item">Customer : '.$customer.'</li>
                                                   <li class="list-group-item">Testimonial : '.$testimonial.'</li>';
                                            
                  echo  '<a class="btn btn-success" data-toggle="modal" href="#myModal1" style="margin:10px;">Edit</a>';
                  echo  '<a class="btn btn-success" href="delete_t.php?id='.$id.'" style="margin:10px;">Delete</a>';
                   ...
                   <form method="post" name="multiple_upload_form" id="multiple_upload_form" enctype="multipart/form-data" action="edit_t.php">
                                    ...
                                    <br>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <textarea name="lnote" class="form-control" id="lnote" cols="3" rows="5" placeholder="Enter  Testimonial (Minimum 10 characters maximum 1500 characters)" minlength="10" maxlength="1500">'.$testimonial.'</textarea>
                                        </div>
