...
alert("Cleared Everything !!");                   }
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-table"></i>Testimonial CMS</h3>
					
				</div>
			</div>                <?php 
                if($_SESSION['user_type']=='admin'){
                    echo '<a class="btn btn-success" data-toggle="modal" href="#myModal" style="margin:15px;">Add Testimonial</a>
                                                                                                ...
                                                                                                <div class="modal-dialog">
                                                                                                    <div class="modal-content">
                                                                                                        ...
                                                                                                        <div class="modal-body">
                                                                                                            <form method="post" name="multiple_upload_form" id="multiple_upload_form" enctype="multipart/form-data" action="upload_t.php">
                    <div class="col-sm-12"> 
                                    <br>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label for="address">Testimonial</label>
                                            <textarea name="lnote" class="form-control" id="lnote" cols="3" rows="5" placeholder="Enter  Long story (Minimum 10 characters maximum 1500 characters)" minlength="10" maxlength="1500" title="Please enter Testimonial(at least 10 characters)"></textarea>
                                        </div>
                        <div class="form-group">
                                            <label for="name">subtitle</label>
                                            <input type="text" class="form-control" name="subtitle" id="subtitle" placeholder="Enter subtitle"  title="Please Enter Subtitle)"/>
                                        </div>
        ...
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
          ...
          <div class="container">
              ...
              <?php
                                    $stmt2 = $mysqli->prepare("SELECT id,customer,testimonial FROM testimonials order by id asc");
                                      if($stmt2->execute()) {
                     ...
                     while ($stmt2->fetch()) {
                        echo '<tr>
                                                                         <td>'.$customer.'</td>
                                                                         <td>'.$testimonial.'</td>
                                                                         <td><a href="show_test.php?id='.$id.'">View/Edit</a></td></tr>';
